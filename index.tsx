...
export class GdmLiveAudio extends LitElement {
  ...
  @state() conversationHistory: {text: string, isUser: boolean}[] = [];
  ...
  render() {
    return html`
      <div>
        <div class="controls">
          <select @change=${this.changeVoice} ?disabled=${this.isRecording}>
            ${this.availableVoices.map(voice => 
              html`<option value=${voice.id} ?selected=${voice.id === this.selectedVoice}>
                ${voice.name}
              </option>`
            )}
          </select>
